...
def test_meta_values():
    ...
    check.equal(meta.script_info.play_res_x, 1280)
    check.equal(meta.script_info.play_res_y, 720)
    # check.equal(meta.audio, "")                         # -> not in this .ass, so let's comment this
    check.equal(meta.project_garbage.video__file, "?dummy:23.976000:2250:1920:1080:11:135:226:c")
